...
export function OfficialGazetteCard({ summary }: OfficialGazetteCardProps) {
    ...
    return (
        <div className="rounded-2xl border border-red-100 bg-red-50/50 dark:bg-red-950/10 dark:border-red-900/50 p-6 h-full">
            ...
            <a
                ...
                className="inline-flex items-center text-xs font-semibold text-red-600 dark:text-red-400 hover:underline gap-1"
            >
